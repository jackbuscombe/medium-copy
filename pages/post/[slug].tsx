        ...
        >
          ...
          <label className="mb-5 block">
            ...
            <input
              ...
              className="form-input mt-1 block w-full rounded border py-2 px-3 shadow outline-none ring-yellow-500 focus:outline-yellow-500 focus:ring"
              type="text"
          ...
          {/* Errors will return here when validation fails */}
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  return {
    ...
    revalidate: 60, // After 60 seconds, it'll reupdate cache
  };
};
